    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          registerElements = function _registerElements(elements) {
            ...
            form.addEventListener('submit', /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(e) {
                var plainInputsValid, name, email, quantity, recurring, queue, plan, paymentResponse, additionalData, handleError, handleErrorWithMessage, userLocation, getCoords, data;
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 8:
                        ...
                        queue = form.querySelector('#queue');
                        plan = form.querySelector('#plan');
                        paymentResponse = paymentForm.querySelector('#payment-response');
                        additionalData = {
                          billing_details: {
                        ...
                        handleErrorWithMessage = function handleErrorWithMessage(response) {
                          handleError();
                          error.classList.add('visible');
                            ...
                            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
                              while (1) {
                                switch (_context.prev = _context.next) {
                                  ...
                                  case 2:
                                    pos = _context.sent;
                                    return _context.abrupt("return", pos.coords);
          ...
          _context3.next = 3;
          return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)("pk_live_51HcdZLDl3uJ5ENdanSSWrnyoB4bJY46uP2GjjQq6t3oGCxCet2rTaOStwZShZA0AzattUS6pQuT5RS26DQ1ANTUq000TMwAlpy");
