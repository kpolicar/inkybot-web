...
__webpack_require__(/*! ./noise */ "./resources/js/noise.js");

__webpack_require__(/*! ./winforms */ "./resources/js/winforms.js");
...
tabs.forEach(function (tab) {
  ...
  var parentUl = parentLi;

  while ((parentUl = parentUl.parentNode) && parentUl.tagName != "UL") {}

  tab.addEventListener('change', function () {
    parentUl.querySelectorAll("li").forEach(function (list) {
      if (list == parentLi) return;
      if (tab.checked) list.classList.remove('hidden');else list.classList.add('hidden');
    });
  });
});
...
datePickers.forEach(function (datepicker) {
  ...
  if (datepicker.dataset.flatpickrLocale === 'fr') {
    config['locale'] = flatpickr_dist_l10n_fr_js__WEBPACK_IMPORTED_MODULE_1__.French;
  }
  ...
  (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__.default)(datepicker, config);
});
            ...
            switch (_context.prev = _context.next) {
              case 0:
                this.shaderFiles = {
                  ...
                  rotation: 0,
                  playing: true
                }, document.querySelectorAll("canvas").length < 1 ? console.log("DID NOT LOAD HERO INKYBOT CANVAS") : (this.minigl = new MiniGl(this.el, null, null, !0), requestAnimationFrame(function () {
...
(function () {
  ...
  var hoverKey = null;
  var resumeId = null; // ── Loop factory ──────────────────────────────────────────────────────
  ...
  var loopA = makeLoop(['sf-cible', 'sf-priorite', 'sf-minimum'], 5000); // Loop B — config-form + queue annotations, every 7 s
...
(function () {
  ...
  a.addEventListener('mouseover', function () {
    ...
    b.classList.remove('scale-110', 'shadow-2xl');
    b.parentNode.classList.remove('z-20');
    c.classList.remove('scale-110', 'shadow-2xl');
  ...
  b.addEventListener('mouseover', function () {
    this.classList.add('scale-110', 'shadow-2xl');
    this.parentNode.classList.add('z-20');
    a.classList.remove('scale-110', 'shadow-2xl');
  ...
  if (f) {
    f.addEventListener('mouseleave', function () {
      b.classList.add('scale-110', 'shadow-2xl');
