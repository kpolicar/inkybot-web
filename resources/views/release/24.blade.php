            ...
            <div class="mx-auto flex flex-col w-full lg:w-3/5 p-6">
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">
                            Support for <strong>Dofus 3.5</strong>
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Improved <strong>speed and stability</strong> of the bot, fewer unexpected interrupts
                        </span>
                    </li>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Added back the <strong>average kamas consumption</strong> tracker
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Better <strong>out of runes</strong> notification
                        </span>
                    </li>
                </ul>
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">
                            There's still some <strong>unexpected bot behavior</strong> on unstable network conditions
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-minus text-3xl mr-3"></i>
                        <span class="pt-1">
                            There's still <strong>low support</strong> for maging weapons
                        </span>
                    </li>
                </ul>
