...
@section('title', 'v0.4 Beta - Release Notes')


@section('hero')
    <x-main-hero>

        <h2 class="tracking-loose text-xl w-full font">v0.4 BETA</h2>
        <h1 class="mb-0 text-5xl font-bold leading-tight">Release notes</h1>
        <h2 class="mb-4 font-bold tracking-loose text-lg w-full font">7th November 2020</h2>

        <p class="leading-normal text-lg mb-2">
            Welcome to the fourth release of Inkybot!
        </p>
        <p class="leading-normal text-lg mb-2">
            ...
            <div class="mx-auto flex flex-col w-full lg:w-3/5 p-6">
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">
                            Added <strong>notifications</strong> for when the maging bot is stopped as well as for version updates.</br>
                            To enable notifications you must opt-in via your browser.
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Large improvements to botting on a <strong>lower resolution</strong> as well as general OCR improvements
                        </span>
                    </li>
                </ul>
