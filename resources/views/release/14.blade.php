...
@section('date', '14th January 2021')
...
@section('content')
    ...
    <section class="bg-white py-8 border-b">
            ...
            <div class="mx-auto flex flex-col w-full lg:w-3/5 p-6">
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">
                            Large improvements to the <strong>Maging AI</strong>, support for more difficult mages<br>
                            <a href="#examples" class="text-gray-600">See examples</a>
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Added <strong>minimum value</strong> column to stats configurator
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Automatically <strong>detect the game's language</strong> and the <strong>path to Dofus</strong>
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Added <strong>new configuration options</strong>, ability to opt-out of settings that
                            are not yet completely stable (rune quantity checking)
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            <strong>Reduced bot stopping</strong> due to rune errors
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            If the bot is stopped the <strong>sink label</strong> in the UI will still be <strong>visible</strong>
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Added option to <strong>reset user settings</strong> in the welcome dialogue
                        </span>
                    </li>
                </ul>
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">
                            Configurable option to <strong>automatically publish successful exos</strong> to the
                    ...
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-clock text-3xl mr-3"></i>
                        <span class="pt-1">Allow users to write custom <strong>maging scripts</strong></span>
                    </li>
                </ul>
        ...
        <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Newly supported</h2>
        <div class="w-full mb-4">
            <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <div class="flex flex-wrap px-10 mb-6">
            <div class="w-full lg:w-1/2 xl:w-1/3 p-1">
                <img src="{{ asset('images/releases/v1.1/war_ap_ini.png') }}"
                     class="m-auto rounded-b"
                     alt="Stat configuration for War's Gauntlet: AP exo with initiative" />
            </div>
            <div class="w-full lg:w-1/2 xl:w-1/3 p-1">
                <img src="{{ asset('images/releases/v1.1/war_mp_perwater.png') }}"
                     class="m-auto rounded-b"
                     alt="Stat configuration for War's Gauntlet: MP exo with optional % Water Resistance exo" />
            </div>
            <div class="w-full lg:w-1/2 xl:w-1/3 p-1">
                <img src="{{ asset('images/releases/v1.1/war_perfire.png') }}"
                     class="m-auto rounded-b"
                     alt="Stat configuration for War's Gauntlet: % Fire Resistance exo" />
            </div>
