...
@section('date', '22nd March 2021')
@section('welcome', 'Welcome to the fifth release of this series!')
            ...
            <div class="mx-auto flex flex-col w-full lg:w-3/5 p-6">
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">Improved <strong>Custom AI scripts</strong>:
                            scripts now behave as extensions to the built-in AI to allow
                            for complete item specialization without the need to write your own fully-fledged maging AI
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            <strong>Performance improvements</strong> for the maging process
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">
                            <strong>QoL improvements</strong>, improve french translation
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-clock text-3xl mr-3"></i>
