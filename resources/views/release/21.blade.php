...
@section('date', '3rd February 2022')
            ...
            <div class="mx-auto flex flex-col w-full lg:w-3/5 p-6">
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">
                            Implemented <strong>don't restore high sink stats immediately</strong> feature - users
                            can now make Inkybot use all remaining sink before returning the stat to the item
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Added <strong>reset statistics</strong> buttons to the Inkybot client
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Added <strong>auto start a new statistics session</strong> upon successful exo mage
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Added <strong>sink safeguard</strong> in case Inkybot calculates the sink over 101
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Improved <strong>Maging AI</strong> - when the AI needs to decrease an overmaged stat, it will prioritize
                            low sink runes to prevent over-decreasing
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Improvements to <strong>custom maging scripts</strong> - added error message for
                            when the script failed to compile (visible as a tooltip)
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Improvements to <strong>custom maging scripts</strong> - added logging
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Improvements to <strong>custom maging scripts</strong> - added ResolveDefault and ResolveDefaultExcludingStats
                            functions to utilize the default AI's behavior within scripts
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Fixed a bug where Inkybot would <strong>reset the sink</strong> if decreasing an overmaged stat
                            resulted in a +sink
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Fixed a bug where the Inkybot client would <strong>crash</strong> upon <strong>opening the statistics page</strong>
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
