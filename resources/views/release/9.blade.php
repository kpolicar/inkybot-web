...
@section('title', 'v0.9 Beta - Release Notes')


@section('hero')
    <x-main-hero>

        <h2 class="tracking-loose text-xl w-full font">v0.9 BETA</h2>
        <h1 class="mb-0 text-5xl font-bold leading-tight">Release notes</h1>
        <h2 class="mb-4 font-bold tracking-loose text-lg w-full font">21st November 2020</h2>

        <p class="leading-normal text-lg mb-2">
            Welcome to the ninth release of Inkybot! We are approaching the official release!
        </p>
        <p class="leading-normal text-lg mb-2">
            ...
            <div class="mx-auto flex flex-col w-full lg:w-3/5 p-6">
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">
                            Further optimizations bring large <strong>Performance improvements</strong> to the bot's maging process,
                            we must now slow down the bot to keep up with the game's bugs
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-plus text-3xl mr-3"></i>
                        <span class="pt-1">
                            Implemented <strong>Archiving of old logs</strong>, maximum 15 log files on disk
                        </span>
                    </li>
                </ul>
                ...
                <ul class="text-black">
                    <li class="p-3 pl-0 flex">
                        ...
                        <span class="pt-1">Various <strong>bug fixes</strong> and <strong>UI improvements</strong> for a smooth official release</span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-clock text-3xl mr-3"></i>
                        <span class="pt-1">
                            <strong>AI Magus Sink usage</strong> will make overmaging with Inkybot make more sense <br />(we don't recommend it just yet)
                        </span>
                    </li>
                    <li class="p-3 pl-0 flex">
                        <i class="fas fa-clock text-3xl mr-3"></i>
