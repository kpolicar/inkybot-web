...
@section('hero')
    <x-main-hero>
        ...
        <p class="my-2">
            By using the services provided by Inkybot, you must agree to the Terms of service, as defined below.
        </p>

        <aside class="text-sm font-bold">
    ...
    <section class="bg-white py-8">
        <div class="container mx-auto pt-4 pb-12 text-gray-800">
            ...
            <p class="my-2">
                ...
                behalf of an entity ("<b>you</b>") and Inkybot ("<b>Company</b>", "<b>we</b>", "<b>us</b>", or "<b>our</b>"),
            ...
            <p class="my-2">
                ...
                reside; (5) you will not access the Site through automated or non-human means, whether through a bot,
                script or otherwise; (6) you will not use the Site for any illegal or unauthorized purpose; and (7) your
            ...
            <ul class="list-disc pl-4 mx-6 my-2 -mt-1">
                <li>Visa</li>
                <li>Mastercard</li>
                <li>Cartes Bancaires</li>
                <li>Cryptocurrency</li>
                <li>Other payment methods provided by Stripe</li>
            </ul>
            ...
            <p class="my-2">
                ...
                You further agree to promptly update account and payment information, including email address, payment
            ...
            <p class="my-2">
                You agree to pay all charges or fees at the prices then in effect for your purchases, and you authorize
                us to charge your chosen payment provider for any such amounts upon making your purchase. If your
                purchase is subject to recurring charges, then you consent to our charging your payment method on a
                recurring basis without requiring your prior approval for each recurring charge, until you notify us of
                your cancellation.
            </p>
            ...
            <p class="my-2">
                We offer a 3-day free trial to new users who register with the Site. The account will not be charged and
            ...
            <ol class="list-decimal pl-4 mx-6 my-2 -mt-1">
                <li>
            ...
            <p class="my-2">
                Any dispute arising from the relationships between the Parties to this contract shall be determined by
                ...
                clause constitutes acceptance. The language of the proceedings shall be English.
            </p>
            ...
            <p class="my-2">
                ...
                ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE TWO (2) MONTH PERIOD PRIOR TO
