<div class="queue-window">
    ...
    <div class="content" data-hl="qf-queue">
        <div class="queue-item">
            ...
            <div class="item-details">
                ...
                <div class="detail-col">
                    <div class="detail-label">{{ __('winforms.queue_config_preset') }}</div>
            ...
            <div class="item-actions">
                <div class="action-btn">{{ __('winforms.queue_move_up') }}</div>
                <div class="action-btn">{{ __('winforms.queue_move_down') }}</div>
                <div class="action-btn">{{ __('winforms.queue_remove') }}</div>
            </div>
        </div>
    ...
    <div class="footer">
        <div class="button">{{ __('winforms.queue_clear') }}</div>
    </div>
</div>
