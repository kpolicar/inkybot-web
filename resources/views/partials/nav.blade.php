    ...
    <div class="container flex flex-wrap flex-columns xl:items-center justify-between mt-0 py-2">
        ...
        <div class="flex justify-between lg:w-auto w-full">
            <div class="pl-4 flex items-center">
                <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl relative"  href="{{ route('home') }}" aria-label="{{ __('common.home') }}">
                    ...
                    <span style="position: absolute; bottom: 5px; right: -38px; background: green; opacity: 90%;" class="text-sm rounded px-1">FREE</span>
                </a>
            </div>
        ...
        <div class="flex-grow lg:flex justify-end lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white lg:bg-transparent lg:text-white text-black p-4 lg:p-0 z-20" id="nav-content">
            ...
            <div class="py-4">
                <a id="navAction" href="{{ route('download') }}" data-download rel="nofollow" class="mx-auto lg:mx-0 lg:mx-2 hover:underline bg-white text-gray-800 font-bold rounded mt-4 lg:mt-0 py-4 px-8 shadow opacity-75">
                    {{ __('common.download') }}
                </a>
            </div>
        </div>
