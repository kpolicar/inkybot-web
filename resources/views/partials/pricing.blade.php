...
<section class="bg-white py-8 pb-12">
    ...
    <div class="container mx-auto px-2 pt-4 pb-2 text-gray-800">
        ...
        <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
            ...
            <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-gray-200 mt-4">
                <div class="flex-1 bg-gray-200 text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                ...
                <div class="flex-none mt-auto bg-gray-200 rounded-b rounded-t-none overflow-hidden shadow p-6">
            ...
            <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-gray-200 mt-4 sm:-mt-6 shadow-lg z-10">
                <div class="flex-1 bg-gray-200 rounded-t rounded-b-none overflow-hidden shadow">
                ...
                <div class="flex-none mt-auto bg-gray-200 rounded-b rounded-t-none overflow-hidden shadow p-6">
                    <div class="w-full pt-6 text-3xl text-gray-600 font-bold text-center">€5 <small class="text-sm">/month</small></div>
                    <div class="flex items-center justify-center">
                        <a href="{{ asset($download_asset) }}"
                           download
                            class="inline-block mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded my-6 py-4 px-8 shadow-lg">Signup</a>
                    </div>
                </div>
            </div>
