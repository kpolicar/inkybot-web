<div class="config-window">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    ...
                    <tr><td>{{ __('stats.vitality') }}</td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td>90</td><td>310</td><td>115</td><td>315</td></tr>
                    <tr><td>{{ __('stats.strength') }}</td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td>17</td><td>55</td><td>21</td><td>62</td></tr>
                    <tr><td>{{ __('stats.intelligence') }}</td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td>17</td><td>55</td><td>21</td><td>62</td></tr>
                    <tr><td>{{ __('stats.agility') }}</td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td>17</td><td>55</td><td>21</td><td>62</td></tr>
                    <tr><td>{{ __('stats.chance') }}</td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td>17</td><td>55</td><td>21</td><td>62</td></tr>
                    <tr><td>{{ __('stats.wisdom') }}</td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td>17</td><td>40</td><td>19</td><td>45</td></tr>
                    ...
                    <tr><td>{{ __('stats.initiative') }}</td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td class="cb-cell"><input type="checkbox" disabled checked></td><td>170</td><td>470</td><td>210</td><td>570</td></tr>
    ...
    <div class="footer">
        <div class="footer-left">
            <a href="#" class="examples-link">{{ __('winforms.config_see_examples') }}</a>
