...
<head>
    ...
    <meta name="keywords" content="Dofus, Bot, Forgemagie, fm, Maging, Mage, Magus, Profession, Kamas, Items, Cheat, Hack, Stats, Game, Automate, Program">
    ...
    <link rel="stylesheet" href="{{ mix('css/rune.css') }}">
