        ...
        <div id="payment-form" class="stripe-payment-form">
            ...
            <form>
                <div class="flex justify-between items-end mb-4">
                    <h1 class="text-left text-3xl font-bold leading-tight w-100">Purchase subscription</h1>
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-gray-400 text-base mt-4 text-left">
                            We do not support recurring payments - you will have to renew your subscription manually each month.
                        </p>
