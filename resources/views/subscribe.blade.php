        ...
        <div id="payment-form" class="stripe-payment-form">
            ...
            <form>
                ...
                <p class="text-gray-400 text-base mt-4 text-left my-4">
                    ...
                    {!! __('forms.subscribe_duration', ['date' => Auth::user()->ExtendedSubscriptionDate()->format('d/m/Y')]) !!}<br>
                ...
                <div class="flex flex-wrap mt-3 -mx-3">
                    ...
                    <div class="w-full md:w-1/2 pl-3 lg:pl-0 px-3">
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                               id="email" name="email" type="email" placeholder="{{ __('forms.subscribe_form_email') }}" value="{{ Auth::user()->email }}" required>
                    </div>
                </div>
